...
import it.polimi.ingsw.model.strategyPatternObjective.ObjectStrategy;
...
class PlayerTest {
   ...
   /* void getObjectiveCard() throws CardNotFoundException {
        ...
        player.setObjectiveCard(objCard);
   ...
   /* @Test
    ...
    void getPlayerHandTest_beforeAndAfterSettingIt() {
        ...
        assertEquals(new HashSet<>(expectedPlayerHand), new HashSet<>(player.getPlayerHand()));
    }
