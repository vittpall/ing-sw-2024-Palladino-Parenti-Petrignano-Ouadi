...
public class GetStarterCard extends ClientToServerMsg {
    ...
    @Override
    public ReturnableObject<StarterCard> functionToCall(LobbyController controller, GameListener playerListener) throws InterruptedException, CardNotFoundException, PlaceNotAvailableException {
